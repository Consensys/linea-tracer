...
public class ContextFragment implements TraceFragment {
  ...
  public Trace trace(Trace trace) {
    ...
    return trace
        ...
        .pContextCallDataContextNumber(callFrame.callData().contextNumber())
        .pContextCallDataOffset(callFrame.callData().offset())
        .pContextCallDataSize(callFrame.callData().size())
        .pContextReturnAtOffset(callFrame.returnAt().offset())
        .pContextReturnAtCapacity(callFrame.returnAt().size())
