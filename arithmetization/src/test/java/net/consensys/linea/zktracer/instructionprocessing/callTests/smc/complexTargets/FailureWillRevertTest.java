...
/**
 * The following uses a smart contract that calls itself but stops after one iteration.
 * At which point it reverts and its caller reverts, too.
 */
public class FailureWillRevertTest {
    ...
    public void selfCall(BytecodeCompiler program, OpCode callOpCode, int gas, int value) {
        program
                ...
                .push(0x33)
                .push(0x46)
                .push(0x59); // just some random bullshit
