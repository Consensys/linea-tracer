...
public class ZkTracer implements LineCountingTracer {
  ...
  private void collectException(final Exception e) {
    ...
    // collect all exceptions except InterruptedException that is rethrown
    // since it means that the execution of the transaction has been interrupted
    if (cause instanceof InterruptedException) {
      log.trace("Interrupted while processing transaction. Rethrowing the exception", e);
