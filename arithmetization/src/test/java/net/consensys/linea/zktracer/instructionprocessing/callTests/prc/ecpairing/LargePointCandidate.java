...
public enum LargePointCandidate {
  ...
  public String hexString() {
      final String result = switch (this) {
    ...
    public final static String LARGE_POINT_AT_INFINITY = "00".repeat(4 * WORD_SIZE);
    public final static String IN_RANGE_SAVE_FOR_LARGE_RE_X =
    ...
    public final static String IN_RANGE_SAVE_FOR_LARGE_IM_X =
    ...
    public final static String IN_RANGE_SAVE_FOR_LARGE_RE_Y =
    ...
    public final static String IN_RANGE_SAVE_FOR_LARGE_IM_Y =
    ...
    public final static String ON_CURVE_BUT_NOT_ON_SUBGROUP =
