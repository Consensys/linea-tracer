...
public class WcpOperation extends ModuleOperation {
  ...
  void trace(Trace.Wcp trace, int stamp) {
    // Split u256 values into 2xu128 limbs
    Bytes arg1Hi = arg1.slice(0, LLARGE);
    Bytes arg1Lo = arg1.slice(LLARGE, LLARGE);
    Bytes arg2Hi = arg2.slice(0, LLARGE);
    Bytes arg2Lo = arg2.slice(LLARGE, LLARGE);
    // Calculate result
  ...
  @Override
  protected int computeLineCount() { // WCP calls are always one line.
    return 1;
  }
}
