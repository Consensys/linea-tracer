...
public class ReplayTestTools {
   ...
   */
  public static void replayAt(ChainConfig chain, String filePath) {
    ...
    try (GZIPInputStream gzipStream = new GZIPInputStream(stream)) {
      ReplayExecutionEnvironment.builder()
          .zkTracer(new ZkTracer(chain))
          .build()
          .replay(chain, new BufferedReader(new InputStreamReader(gzipStream)), filePath);
    } catch (IOException e) {
  ...
  public static void bulkReplay(ChainConfig chain, String directory) {
