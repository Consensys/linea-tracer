...
public class Trace {
  ...
  private final MappedByteBuffer codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize;
  private final MappedByteBuffer codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi;
  ...
  private final MappedByteBuffer deploymentNumberInftyXorByteCodeDeploymentStatusXorMmuPhaseXorPrcRao;
  private final MappedByteBuffer deploymentNumberNewXorCallerAddressHiXorMmuRefOffsetXorPrcReturnGas;
  private final MappedByteBuffer deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi;
  ...
  private final MappedByteBuffer finalInCnfXorMxpSize2NonzeroNoMxpxXorCallSmcFailureCallerWontRevertXorDecFlag2XorUnconstrainedFinal;
  ...
  private final MappedByteBuffer firstInTxnXorStpOogxXorCreateEmptyInitCodeWillRevertXorExtFlagXorValueCurrIsZero;
  ...
  private final MappedByteBuffer hasCodeXorStpWarmthXorCreateEmptyInitCodeWontRevertXorHaltFlagXorValueNextIsCurr;
  ...
  static List<ColumnHeader> headers(int length) {
      ...
      headers.add(new ColumnHeader("hub.ADDRESS_HI_xor_ACCOUNT_ADDRESS_HI_xor_CCRS_STAMP_xor_PRC_CALLEE_GAS_xor_STATIC_GAS_xor_ADDRESS_HI_xor_CALL_DATA_SIZE", 4, length));
      ...
      headers.add(new ColumnHeader("hub.CODE_FRAGMENT_INDEX_xor_ACCOUNT_DEPLOYMENT_NUMBER_xor_EXP_INST_xor_PRC_CALLER_GAS_xor_DEPLOYMENT_NUMBER_xor_COINBASE_ADDRESS_HI", 4, length));
      ...
      headers.add(new ColumnHeader("hub.CODE_SIZE_NEW_xor_BYTE_CODE_CODE_FRAGMENT_INDEX_xor_MMU_EXO_SUM_xor_PRC_CDS_xor_INIT_CODE_SIZE", 4, length));
      headers.add(new ColumnHeader("hub.CODE_SIZE_xor_BYTE_CODE_ADDRESS_HI_xor_MMU_AUX_ID_xor_PRC_CDO_xor_DEPLOYMENT_NUMBER_INFTY_xor_FROM_ADDRESS_HI", 4, length));
      ...
      headers.add(new ColumnHeader("hub.DEPLOYMENT_NUMBER_INFTY_xor_BYTE_CODE_DEPLOYMENT_STATUS_xor_MMU_PHASE_xor_PRC_RAO", 4, length));
      headers.add(new ColumnHeader("hub.DEPLOYMENT_NUMBER_NEW_xor_CALLER_ADDRESS_HI_xor_MMU_REF_OFFSET_xor_PRC_RETURN_GAS", 4, length));
      headers.add(new ColumnHeader("hub.DEPLOYMENT_NUMBER_xor_BYTE_CODE_DEPLOYMENT_NUMBER_xor_MMU_INST_xor_PRC_RAC_xor_TO_ADDRESS_HI", 4, length));
      ...
      headers.add(new ColumnHeader("hub.FINAL_IN_CNF_xor_MXP_SIZE_2_NONZERO_NO_MXPX_xor_CALL_SMC_FAILURE_CALLER_WONT_REVERT_xor_DEC_FLAG_2_xor_UNCONSTRAINED_FINAL", 1, length));
      headers.add(new ColumnHeader("hub.FINAL_IN_TXN_xor_OOB_FLAG_xor_CALL_SMC_SUCCESS_CALLER_WILL_REVERT_xor_DEC_FLAG_3_xor_UNCONSTRAINED_FIRST", 1, length));
      headers.add(new ColumnHeader("hub.FIRST_IN_BLK_xor_STP_EXISTS_xor_CALL_SMC_SUCCESS_CALLER_WONT_REVERT_xor_DEC_FLAG_4_xor_VALUE_CURR_CHANGES", 1, length));
      headers.add(new ColumnHeader("hub.FIRST_IN_CNF_xor_STP_FLAG_xor_CREATE_ABORT_xor_DUP_FLAG_xor_VALUE_CURR_IS_ORIG", 1, length));
      headers.add(new ColumnHeader("hub.FIRST_IN_TXN_xor_STP_OOGX_xor_CREATE_EMPTY_INIT_CODE_WILL_REVERT_xor_EXT_FLAG_xor_VALUE_CURR_IS_ZERO", 1, length));
      ...
      headers.add(new ColumnHeader("hub.HAS_CODE_NEW_xor_CREATE_EXCEPTION_xor_HASH_INFO_FLAG_xor_VALUE_NEXT_IS_ORIG", 1, length));
      headers.add(new ColumnHeader("hub.HAS_CODE_xor_STP_WARMTH_xor_CREATE_EMPTY_INIT_CODE_WONT_REVERT_xor_HALT_FLAG_xor_VALUE_NEXT_IS_CURR", 1, length));
      ...
      headers.add(new ColumnHeader("hub.IS_PRECOMPILE_xor_CREATE_FAILURE_CONDITION_WILL_REVERT_xor_ICPX_xor_VALUE_NEXT_IS_ZERO", 1, length));
      headers.add(new ColumnHeader("hub.LOG_INFO_STAMP", 4, length));
      headers.add(new ColumnHeader("hub.MARKED_FOR_SELFDESTRUCT_NEW_xor_CREATE_NONEMPTY_INIT_CODE_FAILURE_WILL_REVERT_xor_JUMPX_xor_WARMTH", 1, length));
      headers.add(new ColumnHeader("hub.MARKED_FOR_SELFDESTRUCT_xor_CREATE_FAILURE_CONDITION_WONT_REVERT_xor_INVALID_FLAG_xor_VALUE_ORIG_IS_ZERO", 1, length));
      ...
      headers.add(new ColumnHeader("hub.NONCE_NEW_xor_STP_GAS_PAID_OUT_OF_POCKET_xor_GAS_INITIALLY_AVAILABLE", 8, length));
      ...
      headers.add(new ColumnHeader("hub.RLPADDR_FLAG_xor_CREATE_NONEMPTY_INIT_CODE_FAILURE_WONT_REVERT_xor_JUMP_DESTINATION_VETTING_REQUIRED_xor_WARMTH_NEW", 1, length));
  ...
  public Trace (List<MappedByteBuffer> buffers) {
    ...
    this.addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize = buffers.get(1);
    ...
    this.codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi = buffers.get(14);
    ...
    this.codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize = buffers.get(19);
    this.codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi = buffers.get(20);
    ...
    this.deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi = buffers.get(36);
    ...
    this.finalInCnfXorMxpSize2NonzeroNoMxpxXorCallSmcFailureCallerWontRevertXorDecFlag2XorUnconstrainedFinal = buffers.get(45);
    this.finalInTxnXorOobFlagXorCallSmcSuccessCallerWillRevertXorDecFlag3XorUnconstrainedFirst = buffers.get(46);
    this.firstInBlkXorStpExistsXorCallSmcSuccessCallerWontRevertXorDecFlag4XorValueCurrChanges = buffers.get(47);
    this.firstInCnfXorStpFlagXorCreateAbortXorDupFlagXorValueCurrIsOrig = buffers.get(48);
    this.firstInTxnXorStpOogxXorCreateEmptyInitCodeWillRevertXorExtFlagXorValueCurrIsZero = buffers.get(49);
    ...
    this.hasCodeXorStpWarmthXorCreateEmptyInitCodeWontRevertXorHaltFlagXorValueNextIsCurr = buffers.get(57);
    ...
    this.markedForSelfdestructNewXorCreateNonemptyInitCodeFailureWillRevertXorJumpxXorWarmth = buffers.get(65);
    this.markedForSelfdestructXorCreateFailureConditionWontRevertXorInvalidFlagXorValueOrigIsZero = buffers.get(66);
    ...
    this.rlpaddrFlagXorCreateNonemptyInitCodeFailureWontRevertXorJumpDestinationVettingRequiredXorWarmthNew = buffers.get(131);
  ...
  public Trace absoluteTransactionNumber(final long b) {
    ...
    if(b >= 65536L) { throw new IllegalArgumentException("absoluteTransactionNumber has invalid value (" + b + ")"); }
  ...
  public Trace callerContextNumber(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("callerContextNumber has invalid value (" + b + ")"); }
  ...
  public Trace contextNumber(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("contextNumber has invalid value (" + b + ")"); }
  ...
  public Trace contextNumberNew(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("contextNumberNew has invalid value (" + b + ")"); }
  ...
  public Trace contextRevertStamp(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("contextRevertStamp has invalid value (" + b + ")"); }
  ...
  public Trace counterNsr(final long b) {
    ...
    if(b >= 256L) { throw new IllegalArgumentException("counterNsr has invalid value (" + b + ")"); }
  ...
  public Trace domStamp(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("domStamp has invalid value (" + b + ")"); }
  ...
  public Trace gasActual(final Bytes b) {
    ...
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("gasActual has invalid width (" + bs.bitLength() + "bits)"); }
  ...
  public Trace gasCost(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("gasCost has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace gasExpected(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("gasExpected has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace gasNext(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("gasNext has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace height(final long b) {
    ...
    if(b >= 2048L) { throw new IllegalArgumentException("height has invalid value (" + b + ")"); }
    height.put((byte) (b >> 8));
    height.put((byte) b);
  ...
  public Trace heightNew(final long b) {
    ...
    if(b >= 2048L) { throw new IllegalArgumentException("heightNew has invalid value (" + b + ")"); }
  ...
  public Trace hubStamp(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("hubStamp has invalid value (" + b + ")"); }
  ...
  public Trace hubStampTransactionEnd(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("hubStampTransactionEnd has invalid value (" + b + ")"); }
  ...
  public Trace logInfoStamp(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("logInfoStamp has invalid value (" + b + ")"); }
  ...
  public Trace mmuStamp(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("mmuStamp has invalid value (" + b + ")"); }
  ...
  public Trace mxpStamp(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("mxpStamp has invalid value (" + b + ")"); }
  ...
  public Trace nonStackRows(final long b) {
    ...
    if(b >= 256L) { throw new IllegalArgumentException("nonStackRows has invalid value (" + b + ")"); }
  ...
  public Trace pAccountAddressHi(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize has invalid value (" + b + ")"); }
    addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize.put((byte) (b >> 24));
    addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize.put((byte) (b >> 16));
    addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize.put((byte) (b >> 8));
    addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize.put((byte) b);
  ...
  public Trace pAccountAddressLo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("addressLoXorAccountAddressLoXorExpData1XorHashInfoKeccakHiXorAddressLoXorCoinbaseAddressLo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountBalance(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("balanceXorByteCodeAddressLoXorExpData2XorHashInfoKeccakLoXorStorageKeyHiXorFromAddressLo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountBalanceNew(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("balanceNewXorCallerAddressLoXorExpData3XorPushValueHiXorStorageKeyLoXorInitialBalance has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountCodeFragmentIndex(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi has invalid value (" + b + ")"); }
    codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi.put((byte) (b >> 24));
    codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi.put((byte) (b >> 16));
    codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi.put((byte) (b >> 8));
    codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi.put((byte) b);
  ...
  public Trace pAccountCodeHashHi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("codeHashHiXorCallValueXorExpData4XorPushValueLoXorValueCurrHiXorToAddressLo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountCodeHashHiNew(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("codeHashHiNewXorExpData5XorStackItemValueHi1XorValueCurrLoXorValue has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountCodeHashLo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("codeHashLoXorMmuLimb1XorStackItemValueHi2XorValueNextHi has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountCodeHashLoNew(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("codeHashLoNewXorMmuLimb2XorStackItemValueHi3XorValueNextLo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountCodeSize(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi has invalid value (" + b + ")"); }
    codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi.put((byte) (b >> 24));
    codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi.put((byte) (b >> 16));
    codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi.put((byte) (b >> 8));
    codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi.put((byte) b);
  ...
  public Trace pAccountCodeSizeNew(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize has invalid value (" + b + ")"); }
    codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize.put((byte) (b >> 24));
    codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize.put((byte) (b >> 16));
    codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize.put((byte) (b >> 8));
  ...
  public Trace pAccountDeploymentNumber(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi has invalid value (" + b + ")"); }
    deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi.put((byte) (b >> 24));
    deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi.put((byte) (b >> 16));
    deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi.put((byte) (b >> 8));
  ...
  public Trace pAccountDeploymentNumberFinalInBlock(final long b) {
    ...
    if(b >= 65536L) { throw new IllegalArgumentException("deploymentNumberFinalInBlockXorDeploymentNumberFinalInBlock has invalid value (" + b + ")"); }
  ...
  public Trace pAccountDeploymentNumberFirstInBlock(final long b) {
    ...
    if(b >= 65536L) { throw new IllegalArgumentException("deploymentNumberFirstInBlockXorDeploymentNumberFirstInBlock has invalid value (" + b + ")"); }
  ...
  public Trace pAccountDeploymentNumberInfty(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("deploymentNumberInftyXorByteCodeDeploymentStatusXorMmuPhaseXorPrcRao has invalid value (" + b + ")"); }
  ...
  public Trace pAccountDeploymentNumberNew(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("deploymentNumberNewXorCallerAddressHiXorMmuRefOffsetXorPrcReturnGas has invalid value (" + b + ")"); }
  ...
  public Trace pAccountFinalInCnf(final Boolean b) {
    ...
    finalInCnfXorMxpSize2NonzeroNoMxpxXorCallSmcFailureCallerWontRevertXorDecFlag2XorUnconstrainedFinal.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountFinalInTxn(final Boolean b) {
    ...
    finalInTxnXorOobFlagXorCallSmcSuccessCallerWillRevertXorDecFlag3XorUnconstrainedFirst.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountFirstInBlk(final Boolean b) {
    ...
    firstInBlkXorStpExistsXorCallSmcSuccessCallerWontRevertXorDecFlag4XorValueCurrChanges.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountFirstInTxn(final Boolean b) {
    ...
    firstInTxnXorStpOogxXorCreateEmptyInitCodeWillRevertXorExtFlagXorValueCurrIsZero.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountHasCode(final Boolean b) {
    ...
    hasCodeXorStpWarmthXorCreateEmptyInitCodeWontRevertXorHaltFlagXorValueNextIsCurr.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountIsPrecompile(final Boolean b) {
    ...
    isPrecompileXorCreateFailureConditionWillRevertXorIcpxXorValueNextIsZero.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountMarkedForSelfdestruct(final Boolean b) {
    ...
    markedForSelfdestructXorCreateFailureConditionWontRevertXorInvalidFlagXorValueOrigIsZero.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountMarkedForSelfdestructNew(final Boolean b) {
    ...
    markedForSelfdestructNewXorCreateNonemptyInitCodeFailureWillRevertXorJumpxXorWarmth.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountNonce(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("nonceXorStpGasMxpXorBasefee has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
    for(int i=bs.size(); i<8; i++) { nonceXorStpGasMxpXorBasefee.put((byte) 0); }
    // Write bytes
    for(int j=0; j<bs.size(); j++) { nonceXorStpGasMxpXorBasefee.put(bs.get(j)); }
  ...
  public Trace pAccountNonceNew(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("nonceNewXorStpGasPaidOutOfPocketXorGasInitiallyAvailable has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
    for(int i=bs.size(); i<8; i++) { nonceNewXorStpGasPaidOutOfPocketXorGasInitiallyAvailable.put((byte) 0); }
    // Write bytes
    for(int j=0; j<bs.size(); j++) { nonceNewXorStpGasPaidOutOfPocketXorGasInitiallyAvailable.put(bs.get(j)); }
  ...
  public Trace pAccountRlpaddrDepAddrHi(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("rlpaddrDepAddrHiXorCallDataContextNumberXorMmuRefSize has invalid value (" + b + ")"); }
  ...
  public Trace pAccountRlpaddrDepAddrLo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("rlpaddrDepAddrLoXorMmuSrcOffsetHiXorStackItemValueHi4XorValueOrigHi has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountRlpaddrFlag(final Boolean b) {
    ...
    rlpaddrFlagXorCreateNonemptyInitCodeFailureWontRevertXorJumpDestinationVettingRequiredXorWarmthNew.put((byte) (b ? 1 : 0));
  ...
  public Trace pAccountRlpaddrKecHi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("rlpaddrKecHiXorMmuSrcOffsetLoXorStackItemValueLo1XorValueOrigLo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountRlpaddrKecLo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("rlpaddrKecLoXorMmuTgtOffsetLoXorStackItemValueLo2 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountRlpaddrRecipe(final long b) {
    ...
    if(b >= 256L) { throw new IllegalArgumentException("rlpaddrRecipe has invalid value (" + b + ")"); }
  ...
  public Trace pAccountRlpaddrSaltHi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("rlpaddrSaltHiXorMxpGasMxpXorStackItemValueLo3 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountRlpaddrSaltLo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("rlpaddrSaltLoXorMxpOffset1HiXorStackItemValueLo4 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pAccountTrmRawAddressHi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("trmRawAddressHiXorMxpOffset1Lo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pContextCallDataOffset(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("callDataOffsetXorMmuSize has invalid value (" + b + ")"); }
  ...
  public Trace pContextCallDataSize(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("callDataSizeXorMmuSrcId has invalid value (" + b + ")"); }
  ...
  public Trace pContextCallStackDepth(final long b) {
    ...
    if(b >= 2048L) { throw new IllegalArgumentException("callStackDepthXorStackItemHeight1 has invalid value (" + b + ")"); }
  ...
  public Trace pContextContextNumber(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("contextNumberXorMmuTgtId has invalid value (" + b + ")"); }
  ...
  public Trace pContextReturnAtCapacity(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("returnAtCapacityXorMxpInst has invalid value (" + b + ")"); }
  ...
  public Trace pContextReturnAtOffset(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("returnAtOffsetXorOobInst has invalid value (" + b + ")"); }
  ...
  public Trace pContextReturnDataContextNumber(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("returnDataContextNumberXorStpGasStipend has invalid value (" + b + ")"); }
  ...
  public Trace pContextReturnDataOffset(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("returnDataOffsetXorStpInstruction has invalid value (" + b + ")"); }
  ...
  public Trace pContextReturnDataSize(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("returnDataSize has invalid value (" + b + ")"); }
  ...
  public Trace pMiscMxpOffset2Hi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("mxpOffset2Hi has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscMxpOffset2Lo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("mxpOffset2Lo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscMxpSize1Hi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("mxpSize1Hi has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscMxpSize1Lo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("mxpSize1Lo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscMxpSize2Hi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("mxpSize2Hi has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscMxpSize2Lo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("mxpSize2Lo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscMxpWords(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("mxpWords has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData1(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData1 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData2(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData2 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData3(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData3 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData4(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData4 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData5(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData5 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData6(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData6 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData7(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData7 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData8(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData8 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscOobData9(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("oobData9 has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscStpGasHi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("stpGasHi has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscStpGasLo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("stpGasLo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscStpGasUpfrontGasCost(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("stpGasUpfrontGasCostXorGasLeftover has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
    for(int i=bs.size(); i<8; i++) { stpGasUpfrontGasCostXorGasLeftover.put((byte) 0); }
    // Write bytes
    for(int j=0; j<bs.size(); j++) { stpGasUpfrontGasCostXorGasLeftover.put(bs.get(j)); }
  ...
  public Trace pMiscStpValueHi(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("stpValueHi has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pMiscStpValueLo(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 128) { throw new IllegalArgumentException("stpValueLo has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pStackInstruction(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 256) { throw new IllegalArgumentException("instruction has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pStackStackItemHeight2(final long b) {
    ...
    if(b >= 2048L) { throw new IllegalArgumentException("stackItemHeight2 has invalid value (" + b + ")"); }
  ...
  public Trace pStackStackItemHeight3(final long b) {
    ...
    if(b >= 2048L) { throw new IllegalArgumentException("stackItemHeight3 has invalid value (" + b + ")"); }
  ...
  public Trace pStackStackItemHeight4(final long b) {
    ...
    if(b >= 2048L) { throw new IllegalArgumentException("stackItemHeight4 has invalid value (" + b + ")"); }
  ...
  public Trace pStackStackItemStamp1(final long b) {
    ...
    if(b >= 68719476736L) { throw new IllegalArgumentException("stackItemStamp1 has invalid value (" + b + ")"); }
  ...
  public Trace pStackStackItemStamp2(final long b) {
    ...
    if(b >= 68719476736L) { throw new IllegalArgumentException("stackItemStamp2 has invalid value (" + b + ")"); }
  ...
  public Trace pStackStackItemStamp3(final long b) {
    ...
    if(b >= 68719476736L) { throw new IllegalArgumentException("stackItemStamp3 has invalid value (" + b + ")"); }
  ...
  public Trace pStackStackItemStamp4(final long b) {
    ...
    if(b >= 68719476736L) { throw new IllegalArgumentException("stackItemStamp4 has invalid value (" + b + ")"); }
  ...
  public Trace pTransactionGasLimit(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("gasLimit has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pTransactionGasPrice(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("gasPrice has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pTransactionNonce(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("nonce has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pTransactionPriorityFeePerGas(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("priorityFeePerGas has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pTransactionRefundCounterInfinity(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("refundCounterInfinity has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace pTransactionRefundEffective(final Bytes b) {
    ...
    Bytes bs = b.trimLeadingZeros();
    // Sanity check against expected width
    if(bs.bitLength() > 64) { throw new IllegalArgumentException("refundEffective has invalid width (" + bs.bitLength() + "bits)"); }
    // Write padding (if necessary)
  ...
  public Trace programCounter(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("programCounter has invalid value (" + b + ")"); }
  ...
  public Trace programCounterNew(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("programCounterNew has invalid value (" + b + ")"); }
  ...
  public Trace refundCounter(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("refundCounter has invalid value (" + b + ")"); }
  ...
  public Trace refundCounterNew(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("refundCounterNew has invalid value (" + b + ")"); }
  ...
  public Trace relativeBlockNumber(final long b) {
    ...
    if(b >= 65536L) { throw new IllegalArgumentException("relativeBlockNumber has invalid value (" + b + ")"); }
  ...
  public Trace subStamp(final long b) {
    ...
    if(b >= 4294967296L) { throw new IllegalArgumentException("subStamp has invalid value (" + b + ")"); }
  ...
  public Trace validateRow() {
    ...
    if (!filled.get(105)) {
      throw new IllegalStateException("hub.ADDRESS_HI_xor_ACCOUNT_ADDRESS_HI_xor_CCRS_STAMP_xor_PRC_CALLEE_GAS_xor_STATIC_GAS_xor_ADDRESS_HI_xor_CALL_DATA_SIZE has not been filled");
    }
    ...
    if (!filled.get(106)) {
      throw new IllegalStateException("hub.CODE_FRAGMENT_INDEX_xor_ACCOUNT_DEPLOYMENT_NUMBER_xor_EXP_INST_xor_PRC_CALLER_GAS_xor_DEPLOYMENT_NUMBER_xor_COINBASE_ADDRESS_HI has not been filled");
    }
    ...
    if (!filled.get(108)) {
      throw new IllegalStateException("hub.CODE_SIZE_NEW_xor_BYTE_CODE_CODE_FRAGMENT_INDEX_xor_MMU_EXO_SUM_xor_PRC_CDS_xor_INIT_CODE_SIZE has not been filled");
    }

    if (!filled.get(107)) {
      throw new IllegalStateException("hub.CODE_SIZE_xor_BYTE_CODE_ADDRESS_HI_xor_MMU_AUX_ID_xor_PRC_CDO_xor_DEPLOYMENT_NUMBER_INFTY_xor_FROM_ADDRESS_HI has not been filled");
    }
    ...
    if (!filled.get(110)) {
      throw new IllegalStateException("hub.DEPLOYMENT_NUMBER_INFTY_xor_BYTE_CODE_DEPLOYMENT_STATUS_xor_MMU_PHASE_xor_PRC_RAO has not been filled");
    }

    if (!filled.get(111)) {
      throw new IllegalStateException("hub.DEPLOYMENT_NUMBER_NEW_xor_CALLER_ADDRESS_HI_xor_MMU_REF_OFFSET_xor_PRC_RETURN_GAS has not been filled");
    }

    if (!filled.get(109)) {
      throw new IllegalStateException("hub.DEPLOYMENT_NUMBER_xor_BYTE_CODE_DEPLOYMENT_NUMBER_xor_MMU_INST_xor_PRC_RAC_xor_TO_ADDRESS_HI has not been filled");
    }
    ...
    if (!filled.get(54)) {
      throw new IllegalStateException("hub.FINAL_IN_CNF_xor_MXP_SIZE_2_NONZERO_NO_MXPX_xor_CALL_SMC_FAILURE_CALLER_WONT_REVERT_xor_DEC_FLAG_2_xor_UNCONSTRAINED_FINAL has not been filled");
    }

    if (!filled.get(55)) {
      throw new IllegalStateException("hub.FINAL_IN_TXN_xor_OOB_FLAG_xor_CALL_SMC_SUCCESS_CALLER_WILL_REVERT_xor_DEC_FLAG_3_xor_UNCONSTRAINED_FIRST has not been filled");
    }

    if (!filled.get(56)) {
      throw new IllegalStateException("hub.FIRST_IN_BLK_xor_STP_EXISTS_xor_CALL_SMC_SUCCESS_CALLER_WONT_REVERT_xor_DEC_FLAG_4_xor_VALUE_CURR_CHANGES has not been filled");
    }

    if (!filled.get(57)) {
      throw new IllegalStateException("hub.FIRST_IN_CNF_xor_STP_FLAG_xor_CREATE_ABORT_xor_DUP_FLAG_xor_VALUE_CURR_IS_ORIG has not been filled");
    }

    if (!filled.get(58)) {
      throw new IllegalStateException("hub.FIRST_IN_TXN_xor_STP_OOGX_xor_CREATE_EMPTY_INIT_CODE_WILL_REVERT_xor_EXT_FLAG_xor_VALUE_CURR_IS_ZERO has not been filled");
    }
    ...
    if (!filled.get(60)) {
      throw new IllegalStateException("hub.HAS_CODE_NEW_xor_CREATE_EXCEPTION_xor_HASH_INFO_FLAG_xor_VALUE_NEXT_IS_ORIG has not been filled");
    }

    if (!filled.get(59)) {
      throw new IllegalStateException("hub.HAS_CODE_xor_STP_WARMTH_xor_CREATE_EMPTY_INIT_CODE_WONT_REVERT_xor_HALT_FLAG_xor_VALUE_NEXT_IS_CURR has not been filled");
    }
    ...
    if (!filled.get(61)) {
      throw new IllegalStateException("hub.IS_PRECOMPILE_xor_CREATE_FAILURE_CONDITION_WILL_REVERT_xor_ICPX_xor_VALUE_NEXT_IS_ZERO has not been filled");
    }
    ...
    if (!filled.get(63)) {
      throw new IllegalStateException("hub.MARKED_FOR_SELFDESTRUCT_NEW_xor_CREATE_NONEMPTY_INIT_CODE_FAILURE_WILL_REVERT_xor_JUMPX_xor_WARMTH has not been filled");
    }

    if (!filled.get(62)) {
      throw new IllegalStateException("hub.MARKED_FOR_SELFDESTRUCT_xor_CREATE_FAILURE_CONDITION_WONT_REVERT_xor_INVALID_FLAG_xor_VALUE_ORIG_IS_ZERO has not been filled");
    }
    ...
    if (!filled.get(126)) {
      throw new IllegalStateException("hub.NONCE_NEW_xor_STP_GAS_PAID_OUT_OF_POCKET_xor_GAS_INITIALLY_AVAILABLE has not been filled");
    }
    ...
    if (!filled.get(64)) {
      throw new IllegalStateException("hub.RLPADDR_FLAG_xor_CREATE_NONEMPTY_INIT_CODE_FAILURE_WONT_REVERT_xor_JUMP_DESTINATION_VETTING_REQUIRED_xor_WARMTH_NEW has not been filled");
    }
    ...
    if (!filled.get(127)) {
      throw new IllegalStateException("hub.STP_GAS_UPFRONT_GAS_COST_xor_GAS_LEFTOVER has not been filled");
    }
  ...
  public Trace fillAndValidateRow() {
    ...
    if (!filled.get(105)) {
      addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize.position(addressHiXorAccountAddressHiXorCcrsStampXorPrcCalleeGasXorStaticGasXorAddressHiXorCallDataSize.position() + 4);
    }
    ...
    if (!filled.get(106)) {
      codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi.position(codeFragmentIndexXorAccountDeploymentNumberXorExpInstXorPrcCallerGasXorDeploymentNumberXorCoinbaseAddressHi.position() + 4);
    }
    ...
    if (!filled.get(108)) {
      codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize.position(codeSizeNewXorByteCodeCodeFragmentIndexXorMmuExoSumXorPrcCdsXorInitCodeSize.position() + 4);
    }

    if (!filled.get(107)) {
      codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi.position(codeSizeXorByteCodeAddressHiXorMmuAuxIdXorPrcCdoXorDeploymentNumberInftyXorFromAddressHi.position() + 4);
    }
    ...
    if (!filled.get(110)) {
      deploymentNumberInftyXorByteCodeDeploymentStatusXorMmuPhaseXorPrcRao.position(deploymentNumberInftyXorByteCodeDeploymentStatusXorMmuPhaseXorPrcRao.position() + 4);
    }

    if (!filled.get(111)) {
      deploymentNumberNewXorCallerAddressHiXorMmuRefOffsetXorPrcReturnGas.position(deploymentNumberNewXorCallerAddressHiXorMmuRefOffsetXorPrcReturnGas.position() + 4);
    }

    if (!filled.get(109)) {
      deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi.position(deploymentNumberXorByteCodeDeploymentNumberXorMmuInstXorPrcRacXorToAddressHi.position() + 4);
    }
    ...
    if (!filled.get(54)) {
      finalInCnfXorMxpSize2NonzeroNoMxpxXorCallSmcFailureCallerWontRevertXorDecFlag2XorUnconstrainedFinal.position(finalInCnfXorMxpSize2NonzeroNoMxpxXorCallSmcFailureCallerWontRevertXorDecFlag2XorUnconstrainedFinal.position() + 1);
    }

    if (!filled.get(55)) {
      finalInTxnXorOobFlagXorCallSmcSuccessCallerWillRevertXorDecFlag3XorUnconstrainedFirst.position(finalInTxnXorOobFlagXorCallSmcSuccessCallerWillRevertXorDecFlag3XorUnconstrainedFirst.position() + 1);
    }

    if (!filled.get(56)) {
      firstInBlkXorStpExistsXorCallSmcSuccessCallerWontRevertXorDecFlag4XorValueCurrChanges.position(firstInBlkXorStpExistsXorCallSmcSuccessCallerWontRevertXorDecFlag4XorValueCurrChanges.position() + 1);
    }

    if (!filled.get(57)) {
      firstInCnfXorStpFlagXorCreateAbortXorDupFlagXorValueCurrIsOrig.position(firstInCnfXorStpFlagXorCreateAbortXorDupFlagXorValueCurrIsOrig.position() + 1);
    }

    if (!filled.get(58)) {
      firstInTxnXorStpOogxXorCreateEmptyInitCodeWillRevertXorExtFlagXorValueCurrIsZero.position(firstInTxnXorStpOogxXorCreateEmptyInitCodeWillRevertXorExtFlagXorValueCurrIsZero.position() + 1);
    }
    ...
    if (!filled.get(60)) {
      hasCodeNewXorCreateExceptionXorHashInfoFlagXorValueNextIsOrig.position(hasCodeNewXorCreateExceptionXorHashInfoFlagXorValueNextIsOrig.position() + 1);
    }

    if (!filled.get(59)) {
      hasCodeXorStpWarmthXorCreateEmptyInitCodeWontRevertXorHaltFlagXorValueNextIsCurr.position(hasCodeXorStpWarmthXorCreateEmptyInitCodeWontRevertXorHaltFlagXorValueNextIsCurr.position() + 1);
    }
    ...
    if (!filled.get(61)) {
      isPrecompileXorCreateFailureConditionWillRevertXorIcpxXorValueNextIsZero.position(isPrecompileXorCreateFailureConditionWillRevertXorIcpxXorValueNextIsZero.position() + 1);
    }
    ...
    if (!filled.get(63)) {
      markedForSelfdestructNewXorCreateNonemptyInitCodeFailureWillRevertXorJumpxXorWarmth.position(markedForSelfdestructNewXorCreateNonemptyInitCodeFailureWillRevertXorJumpxXorWarmth.position() + 1);
    }

    if (!filled.get(62)) {
      markedForSelfdestructXorCreateFailureConditionWontRevertXorInvalidFlagXorValueOrigIsZero.position(markedForSelfdestructXorCreateFailureConditionWontRevertXorInvalidFlagXorValueOrigIsZero.position() + 1);
    }
    ...
    if (!filled.get(126)) {
      nonceNewXorStpGasPaidOutOfPocketXorGasInitiallyAvailable.position(nonceNewXorStpGasPaidOutOfPocketXorGasInitiallyAvailable.position() + 8);
    }
    ...
    if (!filled.get(64)) {
      rlpaddrFlagXorCreateNonemptyInitCodeFailureWontRevertXorJumpDestinationVettingRequiredXorWarmthNew.position(rlpaddrFlagXorCreateNonemptyInitCodeFailureWontRevertXorJumpDestinationVettingRequiredXorWarmthNew.position() + 1);
    }
    ...
    if (!filled.get(127)) {
      stpGasUpfrontGasCostXorGasLeftover.position(stpGasUpfrontGasCostXorGasLeftover.position() + 8);
    }
