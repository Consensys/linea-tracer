  ...
  public static PrecompileInvocation of(final Hub hub, Precompile p) {
    final boolean hubFailure =
        switch (p) {
          ...
          case EC_PAIRING -> EcPairingEffectiveCalls.isHubFailure(hub);
    ...
    final boolean ramFailure =
        !hubFailure
            && switch (p) {
              ...
              case EC_PAIRING -> EcPairingEffectiveCalls.isRamFailure(hub);
    ...
    final long precompilePrice =
        hubFailure || ramFailure
            ...
            : switch (p) {
              ...
              case EC_PAIRING -> EcPairingEffectiveCalls.gasCost(hub);
