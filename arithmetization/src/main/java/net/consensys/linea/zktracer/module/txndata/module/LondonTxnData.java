...
import net.consensys.linea.zktracer.module.txndata.moduleOperation.TxnDataOperationLondon;
...
public class LondonTxnData extends TxnData<TxnDataOperationLondon> {
