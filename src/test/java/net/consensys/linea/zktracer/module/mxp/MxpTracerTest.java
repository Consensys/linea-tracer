...
import static net.consensys.linea.zktracer.OpCode.MLOAD;
...
class MxpTracerTest extends AbstractModuleTracerCorsetTest {

  @Override
  protected ModuleTracer getModuleTracer() {
    return new MxpTracer();
  }
  ...
  protected Stream<Arguments> provideNonRandomArguments() {
    ...
    return Stream.of(Arguments.of(MLOAD, List.of(arg1, arg2)));
  }
}
