...
public class CompressedFileWriter{
  ...
  public CompressedFileWriter(Path path, String pattern) throws IOException {
    ...
    this.arg1Hi = new BigIntegerCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("ARG_1_HI" + pattern).toString(), "rw")));
    this.arg1Lo = new BigIntegerCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("ARG_1_LO" + pattern).toString(), "rw")));
    this.arg2Hi = new BigIntegerCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("ARG_2_HI" + pattern).toString(), "rw")));
    this.arg2Lo = new BigIntegerCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("ARG_2_LO" + pattern).toString(), "rw")));
    this.byte1 = new UnsignedByteCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("BYTE_1" + pattern).toString(), "rw")));
    this.byte2 = new UnsignedByteCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("BYTE_2" + pattern).toString(), "rw")));
    this.ct = new BigIntegerCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("CT" + pattern).toString(), "rw")));
    this.inst = new BigIntegerCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("INST" + pattern).toString(), "rw")));
    this.overflow = new BooleanCompressedFileWriter(new FW(new RandomAccessFile(path.resolve("OVERFLOW" + pattern).toString(), "rw")));
