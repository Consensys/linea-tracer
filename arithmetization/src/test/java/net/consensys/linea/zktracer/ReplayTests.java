...
public class ReplayTests {
  ...
  @Disabled(
      "This test fails due to trying to decrement a value greater than 0 to a 0 balance from postRollbackCalleeSnapshot in AccountSnapshot")
  @Test
  void issue1104b() {
    replay("8019521.json.gz");
  }

  @Test
  void issue1104c() {
    replay("8005327.json.gz");
  }
}
