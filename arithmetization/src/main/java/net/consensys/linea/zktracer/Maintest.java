...
//        file.createNewFile();
//
//        Column<Long> c1 = LongColumn.create("testing1", LongStream.range(1L, 1_000));
//        Column<Long> c2 = LongColumn.create("testing2", LongStream.range(1L, 1_000));
//        Column<Long> c3 = LongColumn.create("testing3", LongStream.range(1L, 1_000));
//        Column<Long> c4 = LongColumn.create("testing4", LongStream.range(1L, 1_000));
//        Column<Long> c5 = LongColumn.create("testing5", LongStream.range(1L, 1_000));
//        Column<Long> c6 = LongColumn.create("testing6", LongStream.range(1L, 1_000));
//        var toBePersisted = Table.create(c1, c2, c3, c4, c5, c6);
//
//        Stopwatch sw = Stopwatch.createStarted();
//        PARQUET_WRITER.write(toBePersisted, TablesawParquetWriteOptions.builder(file)//.withCompressionCode(TablesawParquetWriteOptions.CompressionCodec.UNCOMPRESSED)
//                .build());
