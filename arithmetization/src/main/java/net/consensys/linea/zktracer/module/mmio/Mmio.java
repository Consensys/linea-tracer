  ...
  void trace(Trace trace, MmioData mmioData, final int stamp) {
    ...
    for (short ct = 0; ct < numberOfRowOfMmioInstruction(mmioData.instruction()); ct++) {
      ...
      trace
          ...
          .bin1(!mmioData.bin1().isEmpty() && mmioData.bin1().get(ct))
          .bin2(!mmioData.bin2().isEmpty() && mmioData.bin2().get(ct))
          .bin3(!mmioData.bin3().isEmpty() && mmioData.bin3().get(ct))
          .bin4(!mmioData.bin4().isEmpty() && mmioData.bin4().get(ct))
          .bin5(!mmioData.bin5().isEmpty() && mmioData.bin5().get(ct))
