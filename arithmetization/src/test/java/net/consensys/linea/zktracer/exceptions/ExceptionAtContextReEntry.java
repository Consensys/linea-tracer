 ...
 * when resuming the execution of the parent frame after an exception in the child frame.
 * This tests whether {@link Hub#unlatchStack} behaves appropriately for <b>CALL</b>-type and <b>CREATE</b>-type instructions,
 * when either
 *
 * <ul>
 ...
 * </ul>
 *
 * <p><b>Note.</b> All exceptions that we test are <b>stackUnderflowException</b>'s.</p>
 */
public class ExceptionAtContextReEntry {

    /**
     * {@link #firstInstructionAfterResumingFromUnsuccessfulMessageCallIsExceptional}
     * tests what happens if both
     *
     * <ul>
        ...
        program
                .push(initCodeBytes)
                        .push(0)
                                .op(MSTORE);
        program
                .push(initCodeBytes.size())
                .push(WORD_SIZE - initCodeBytes.size())
                .push(0)
                .op(CREATE);
    ...
    /**
     * {@link #firstInstructionAfterResumingFromSuccessfulMessageCallIsExceptional}
     * tests what happens if both
     *
     * <ul>
     *     <li> a STATICCALL ends in an exception
    ...
    /**
     * {@link #firstInstructionAfterResumingFromSuccessfulContractCreationIsExceptional}
     * tests what happens if the first instruction after a successful deployment is
     * exceptional.
     *
    ...
    public void firstInstructionAfterResumingFromSuccessfulContractCreationIsExceptional() {
        ...
        // the previous operation leaves the stack in the following state
        // | a ], where a is either 0 or the deployment address, in the present case: the deployment address
        // i.e. containing precisely one item. The ADD instruction will therefore raise a stackUnderflowException.
        program.op(ADD);
    ...
    /**
     * {@link #firstInstructionAfterResumingFromUnsuccessfulContractCreationIsExceptional}
     * tests what happens if the first instruction after an unsuccessful deployment is
     * exceptional, too.
     *
     * <p><b>Note.</b> The exceptions is a <b>stackUnderflowException</b>.
     */
