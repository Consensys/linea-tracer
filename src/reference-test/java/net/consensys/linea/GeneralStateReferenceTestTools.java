...
public class GeneralStateReferenceTestTools {
  ...
  public static void executeTest(final GeneralStateTestCaseEipSpec spec) {
    ...
    final ZkTraceBuilder zkTraceBuilder = new ZkTraceBuilder();
    ...
    AssertionsForClassTypes.assertThat(CorsetValidator.isValid(zkTraceBuilder.build().toJson())).isTrue();
  }
