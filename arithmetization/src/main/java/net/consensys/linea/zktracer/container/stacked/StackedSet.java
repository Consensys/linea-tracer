...
public class StackedSet<E extends ModuleOperation> {
   ...
   * added to the set of committed operations {@link StackedSet#operationsCommitedToTheConflation}.
   * {@link StackedSet#operationsInTransaction} is further reset to be empty.
   */
  public void enter() {
