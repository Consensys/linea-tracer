...
import net.consensys.linea.zktracer.container.stacked.StackedMap;
...
public class Conflation {
  ...
  private final StackedMap<StackHeightCheck> stackHeightChecksForStackUnderflows =
      new StackedMap<>(256, 32);
  private final StackedMap<StackHeightCheck> stackHeightChecksForStackOverflows =
      new StackedMap<>(256, 32);
}
