...
/** instruction decoder for mxp module. */
public class InstructionDecoder {
  ...
  static {
    ...
    instructionDecoder.get(OpCode.MLOAD).put(Columns.MXP_TYPE_2.name(), 1);
    instructionDecoder.put(OpCode.MSTORE, new HashMap<>());
    instructionDecoder.get(OpCode.MSTORE).put(Columns.MXP_TYPE_2.name(), 1);
    instructionDecoder.put(OpCode.MSTORE8, new HashMap<>());
    instructionDecoder.get(OpCode.MSTORE8).put(Columns.MXP_TYPE_3.name(), 1);
  }

  /** decodes the given instruction to an integer. */
