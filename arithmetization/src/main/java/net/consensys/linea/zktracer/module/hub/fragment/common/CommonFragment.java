...
public final class CommonFragment implements TraceFragment {
  ...
  public Trace trace(Trace trace) {
    ...
    return trace
        ...
        .height(commonFragmentValues.hubProcessingPhase == HubProcessingPhase.TX_EXEC ? commonFragmentValues.height : 0)
        .heightNew(commonFragmentValues.hubProcessingPhase == HubProcessingPhase.TX_EXEC ? commonFragmentValues.heightNew : 0)
