...
public class CallDataParameter {
  ...
  private String bbs(boolean variant) {
    return Bytes32.leftPad(Bytes.ofUnsignedShort(bbsShort(variant))).toString();
  }

  private String ebs(boolean variant) {
    return Bytes32.leftPad(Bytes.ofUnsignedShort(ebsShort(variant))).toString();
  }

  private String mbs(boolean variant) {
    return Bytes32.leftPad(Bytes.ofUnsignedShort(mbsShort(variant))).toString();
  }

  static String BASE_512_a =
