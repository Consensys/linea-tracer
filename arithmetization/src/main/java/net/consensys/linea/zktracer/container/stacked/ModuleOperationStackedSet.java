 ...
 * ModuleOperationStackedSet#operationsCommitedToTheConflation()} represents the set of all operations since the
 * beginning of the conflation and {@link ModuleOperationStackedSet#operationsInTransaction()} represents the
...
public class ModuleOperationStackedSet<E extends ModuleOperation> extends StackedSet<E> {
   ...
   * {@link ModuleOperationStackedSet#operationsInTransaction()} (which is empty if no such transaction exists) is
   * added to the set of committed operations {@link
   * ModuleOperationStackedSet#operationsCommitedToTheConflation()}. {@link ModuleOperationStackedSet#operationsInTransaction()}
