...
public class ReplayTests {
  ...
  @Test
  void fatMxp() {
    replay(OLD_LINEA_MAINNET, "2492975-2492977.mainnet.json.gz");
  }
  ...
  void failingMmuModexp() {
    replay(OLD_LINEA_MAINNET, "5995162.mainnet.json.gz");
  }

  @Test
  void failRlpAddress() {
    replay(OLD_LINEA_MAINNET, "5995097.mainnet.json.gz");
  }

  @Test
  void rlprcptManyTopicsWoLogData() {
    replay(OLD_LINEA_MAINNET, "6569423.mainnet.json.gz");
  }

  @Test
  void multipleFailingCallToEcrecover() {
    replay(OLD_LINEA_MAINNET, "5000544.mainnet.json.gz");
  }

  @Test
  @Tag("nightly")
  void incident777zkGethMainnet() {
    replay(OLD_LINEA_MAINNET, "7461019-7461030.mainnet.json.gz");
  }

  @Test
  void issue1006() {
    replay(OLD_LINEA_MAINNET, "6032696-6032699.mainnet.json.gz");
  }

  @Test
  void issue1004() {
    replay(OLD_LINEA_MAINNET, "6020023-6020029.mainnet.json.gz");
  }
  ...
  void block_6110045() {
    ...
    // within it.
    replay(OLD_LINEA_MAINNET, "6110045.mainnet.json.gz");
  }

  @Test
  void failingCreate2() {
    replay(OLD_LINEA_MAINNET, "2250197.mainnet.json.gz");
  }

  @Test
  void blockHash1() {
    replay(OLD_LINEA_MAINNET, "8718090.mainnet.json.gz");
  }

  @Test
  void blockHash2() {
    replay(OLD_LINEA_MAINNET, "8718330.mainnet.json.gz");
  }
  ...
  void negativeNumberOfMmioInstruction() {
    replay(OLD_LINEA_MAINNET, "6029454-6029459.mainnet.json.gz");
  }

  @Test
  void simpleSelfDestruct() {
    replay(OLD_LINEA_MAINNET, "50020-50029.mainnet.json.gz");
  }

  // TODO: should be replaced by a unit test triggering a failed CREATE2
  @Test
  void failedCreate2() {
    replay(OLD_LINEA_MAINNET, "41640-41649.mainnet.json.gz");
  }

  @Test
  void largeInitCode() {
    replay(OLD_LINEA_SEPOLIA, "3318494.sepolia.json.gz");
  }
  ...
  void hotOrColdPrecompile() {
    replay(OLD_LINEA_MAINNET, "2019510-2019519.mainnet.json.gz");
  }
  ...
  void callDataCopyCnNotFound() {
    replay(OLD_LINEA_MAINNET, "67050-67059.mainnet.json.gz");
  }
  ...
  void mainnet1339346ContextRevertTwice() {
    replay(OLD_LINEA_MAINNET, "1339346.mainnet.json.gz");
  }

  @Test
  void legacyTxWithoutChainID() {
    replay(OLD_LINEA_SEPOLIA, "254251.sepolia.json.gz");
  }
