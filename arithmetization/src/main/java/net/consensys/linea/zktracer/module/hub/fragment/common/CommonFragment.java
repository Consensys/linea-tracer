...
public final class CommonFragment implements TraceFragment {
  ...
  public Trace trace(Trace trace) {
    ...
    return trace
        ...
        .refundCounter((commonFragmentValues.hubProcessingPhase == TX_EXEC) ? commonFragmentValues.gasRefund : 0)
        .refundCounterNew((commonFragmentValues.hubProcessingPhase == TX_EXEC) ? commonFragmentValues.gasRefundNew : 0)
