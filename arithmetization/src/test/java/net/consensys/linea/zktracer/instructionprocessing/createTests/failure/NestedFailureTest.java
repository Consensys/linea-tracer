...
public class NestedFailureTest {
    ...
    public void nestedFailureTest(OpCode callOpCode) {
        ...
        ToyAccount accountContainingInitCode = ToyAccount.builder()
        ...
        fullCodeCopyOf(entryPoint, accountContainingInitCode);
        entryPoint
                .push(salt02) // salt
                .op(MSIZE) // size
                .push(0) // offset
        ...
        ToyAccount entryPointAccount = ToyAccount.builder()
