...
class ExampleTxTest {
  ...
  void test() {
    ...
    ToyAccount senderAccount = ToyAccount.builder()
      .balance(Wei.of(5))
      .nonce(5)
      .address(senderAddress)
      .code(BytecodeCompiler.newProgram().compile())
      .build();

    ToyAccount receiverAccount = ToyAccount.builder()
      .balance(Wei.ONE)
      .nonce(6)
    ...
    ToyWorld toyWorld = ToyWorld.builder()
