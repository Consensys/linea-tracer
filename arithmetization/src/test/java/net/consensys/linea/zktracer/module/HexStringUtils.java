...
public class HexStringUtils {
 ...
 /**
 * Generates a hexadecimal string with `k` bytes, where the first `k-l` bytes are "00" and the last `l` bytes are "ff".
 *
...
/**
 * Generates a hexadecimal string with `a` leading "00" bytes, followed by `b` "ff" bytes, and `c` trailing "00" bytes.
 *
